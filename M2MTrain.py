...
def trainwithPER(setID,typ='teacher',learning_rate=1e-4, drop_out=0.4,Layers=[2,1,2], N_hidden=2048, N_cell=2048, steps=20,ahead=20, L2_lambda=1e-4,patience=3, continue_train=0, evalPER=0):
    ...
    ff=M2MGRU(learning_rate=learning_rate, drop_out=drop_out, Layers=Layers, N_hidden=N_hidden, N_cell=N_cell, D_input=asr.train_data[0][0][0].shape[2], D_out=120, Task_type='classification', L2_lambda=L2_lambda, _EPSILON=1e-15)
